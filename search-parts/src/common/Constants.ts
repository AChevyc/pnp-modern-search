export class Constants {
    ...
    public static readonly PNP_MODERN_SEARCH_EVENT_NAME = 'PnPModernSearch';
}
...
export class TestConstants {
    public static DataVisualizerWebPart = "dataVisualizerWebPart";
    public static DataVisualizerErrorMessage = "dataVisualizerErrorMessage";
    public static DataVisualizerLoadingOverlay = "dataVisualizerLoadingOverlay";
    public static DataVisualizerWebPartTitle = "dataVisualizerWebPartTitle";
    public static DataVisualizerLicenseMessageBar = "dataVisualizerLicenseMessageBar";
