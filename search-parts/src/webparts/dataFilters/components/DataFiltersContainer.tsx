...
import { IDataFiltersContainerProps } from './IDataFiltersContainerProps';
import { TemplateRenderer } from '../../../controls/TemplateRenderer/TemplateRenderer';
import { IDataFiltersContainerState } from './IDataFiltersContainerState';
...
import { IDataFiltersTemplateContext } from '../../../models/common/ITemplateContext';
import { flatten } from '@microsoft/sp-lodash-subset';
import { DisplayMode } from '@microsoft/sp-core-library';
import { DataFilterHelper } from '../../../helpers/DataFilterHelper';

export default class DataFiltersContainer extends React.Component<IDataFiltersContainerProps, IDataFiltersContainerState> {

  private componentRef: React.RefObject<any>;

  public constructor(props: IDataFiltersContainerProps) {
  ...
  public render(): React.ReactElement<IDataFiltersContainerProps> {
  ...
  public componentDidUpdate(prevProps: IDataFiltersContainerProps, prevState: IDataFiltersContainerState) {
  ...
  private getTemplateContext(): IDataFiltersTemplateContext {
