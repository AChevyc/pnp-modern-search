  ...
  return {
    General: {
      PlaceHolder: {
        ...
        Description: "Displays data filters from a connected data visualizer Web Part",
        ConfigureBtnLabel: "Configure"
      },
      NoAvailableFilterMessage: "No available filter to display.",
      WebPartDefaultTitle: "Data Filters Web Part"
    },
    PropertyPane: {      
      ConnectionsPage: {
      ...
      DataFilterCollection: {
        ...
        CustomizeFiltersDescription: "Configure data filters by adding or removing rows. You can select fields from the data source results (if already selected) or use static values for filters.",
