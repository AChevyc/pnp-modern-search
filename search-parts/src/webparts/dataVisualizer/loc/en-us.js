define([], function() {
  return {
    General: {
      ...
      WebPartDefaultTitle: "Data Visualizer Web Part",
    ...
    PropertyPane: {
      DataSourcePage: {
        ...
        CachingOptionsGroupName: "Caching options",
        CachingEnableTglLabel: "Enable caching",
        CachingDurationLabel: "Cache duration in minutes",
        CachingResetCacheLabel: "Clear cache",
        CacheClearedMessage: "Cache cleared",
        CachingEnableTgInfoMessage: "If enabled, only the results first page will be cached for the first page load scenario.",
