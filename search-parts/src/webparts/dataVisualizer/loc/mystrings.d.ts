declare interface IDataVisualizerWebPartStrings {
  General: {
    PlaceHolder: {
      EditLabel: string;
      IconText: string;
  ...
  PropertyPane: {
    DataSourcePage: {
      ...
      CachingOptionsGroupName: string;
      CachingEnableTglLabel: string;
      CachingDurationLabel: string;
      CachingResetCacheLabel: string;
      CacheClearedMessage: string;
      CachingEnableTgInfoMessage: string;
...
declare module 'DataVisualizerWebPartStrings' {
  const strings: IDataVisualizerWebPartStrings;
  export = strings;
}
