...
import * as webPartStrings from 'DataVerticalsWebPartStrings';
import { IDataVerticalsContainerProps } from './components/IDataVerticalsContainerProps';
import { IDataVerticalsWebPartProps } from './IDataVerticalsWebPartProps';
import { TextField, ITextFieldProps, Dropdown, IDropdownProps } from 'office-ui-fabric-react';
import DataVerticalsContainer from './components/DataVerticalsContainer';
...
export default class DataVerticalsWebPart extends BaseWebPart<IDataVerticalsWebPartProps> implements IDynamicDataCallables {
  ...
  public render(): void {
    ...
    renderRootElement = React.createElement(
      ...
      } as IDataVerticalsContainerProps
    );
  ...
  public getPropertyDefinitions(): IDynamicDataPropertyDefinition[] {
    ...
    return [
       {
           id: ComponentType.DataVerticals,
  ...
  public getPropertyValue(propertyId: string) {
    switch (propertyId) {
      ...
      case ComponentType.DataVerticals:
            return { 
    ...
    propertyPanePages.push(
      {
        groups: [
          {
            groupName: webPartStrings.PropertyPane.DataVerticalsGroupName,
  ...
  private async onVerticalSelected(itemKey: string): Promise<void> {
    ...
    this.context.dynamicDataSourceManager.notifyPropertyChanged(ComponentType.DataVerticals);
  }
}
