...
import styles from './DataVerticalsContainer.module.scss';
import { IDataVerticalsContainerProps } from './IDataVerticalsContainerProps';
...
import { IDataVerticalsContainerState } from './IDataVerticalsContainerState';
import { BuiltinTokenNames } from '../../../services/tokenService/TokenService';

export default class DataVerticalsContainer extends React.Component<IDataVerticalsContainerProps, IDataVerticalsContainerState> {
  ...
  public render(): React.ReactElement<IDataVerticalsContainerProps> {
