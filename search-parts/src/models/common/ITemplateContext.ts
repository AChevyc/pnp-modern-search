...
/**
 * Represents the context passed to the Handlebars template (Data Visualizer)
 */
export interface IDataResultsTemplateContext {
     ...
     */
    properties: IDataVisualizerWebPartProps;
 ...
 */
export interface IDataFiltersTemplateContext {
     ...
     */
    properties: IDataFiltersWebPartProps;
}