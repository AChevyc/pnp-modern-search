...
import IDataFiltersWebPartProps from '../webparts/dataFilters/IDataFiltersWebPartProps';
import IDataVisualizerWebPartProps from '../webparts/dataVisualizer/IDataVisualizerWebPartProps';
...
export class LayoutHelper {
     ...
     */
    public static async getLayoutInstance(rootScope: ServiceScope, context: WebPartContext, properties: IDataFiltersWebPartProps | IDataVisualizerWebPartProps, layoutKey: string, layoutDefinitions: ILayoutDefinition[]): Promise<ILayout> {
