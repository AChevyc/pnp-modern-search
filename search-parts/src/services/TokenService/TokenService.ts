...
const TokenService_ServiceKey = 'PnPModernSearchTokenService';

export enum BuiltinTokenNames {

    /**
     * The number of items configured per page
     */
    itemsCountPerPage = 'itemsCountPerPage',

    /**
     * The theorical start row number (= items per page * page number)
     */
    startRow = 'startRow',

    /**
     * The input query text configured in the data visualizer Web Part
     */
...
export class TokenService implements ITokenService {
    ...
    private tokenValuesList: { [key: string]: any } = {
        [BuiltinTokenNames.itemsCountPerPage]: null,
        [BuiltinTokenNames.startRow]: null,
    ...
    /**
     * Resolves current page values from tokens in the specified string
    ...
    /**
     * Resolves current page context related tokens in the specified string
     * @param inputString the input string containing tokens
     */
    ...
    /**
     * Resolves current user property values from tokens in the specified string
     * @param inputString the input string containing tokens
     */
    ...
    /**
     * Resolves date related tokens in the specified string
     * @param inputString the input string containing tokens
     */
    ...
    /**
     * Resolves query string related tokens in the specified string
     * @param inputString the input string containing tokens
     */
    ...
    /**
     * Resolves current web related tokens in the specified string
     * @param inputString the input string containing tokens
     */
    ...
    /**
     * Resolves current site related tokens in the specified string
     * @param inputString the input string containing tokens
     */
    ...
    /**
     * Resolves current hub site related tokens in the specified string
     * @param inputString the input string containing tokens
     */
    ...
    /**
     * Resolves current Office 365 group related tokens in the specified string
     * @param inputString the input string containing tokens
     */
    ...
    /**
     * Resolves current list related tokens in the specified string
     * @param inputString the input string containing tokens
     */
    ...
    /**
     * Resolves legacy page tokens in the specified string
     * @param inputString the input string containing tokens
     */
